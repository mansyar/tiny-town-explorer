...
- **Instant-answer vehicle switching (added 2026-09-26)** — the vehicle switcher
  ...
  control in the game. Three additions, no new module, no new dependency, asset
  or text surface:
  ...
  - The pending answer **reuses the generation counter the arbitration already
    ...
    standing. The queue, the generation scheme, `commitVehicleActor`,
    `restoreVehicleActor` and `activate` are untouched, and the five
